...
# Modificación para hacer que "Raza" sea el índice
...
ruta_descargas <- file.path(Sys.getenv("HOME"), "Downloads", "distribucion.pdf")

ggsave(filename = ruta_descargas, plot = panel_graficos, width = 8, height = 6)
